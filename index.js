...
// const BOOTSTRAP_DOC_ID = "441f8ea5-c86f-49a7-87f9-9cc60225e15e"
const BOOTSTRAP_DOC_ID = urlParams.get("bootstrapDocId") ?? "cf4edf99-2fa3-4c05-b87d-7e079dc39375"
...
const bootstrapDocHandle = repo.find(BOOTSTRAP_DOC_ID) // bootstrap("bootstrapKey", (doc) => repo.find(PRECOOKED_BOOTSTRAP_DOC_ID))
...
if (rootModule.mount) {
  rootModule.mount(document.getElementById("root"), { documentId: BOOTSTRAP_DOC_ID })
}
