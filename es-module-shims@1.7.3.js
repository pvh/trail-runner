...
;(function () {
  ...
  function parse(l, k = "@") {
            ...
            e: while (1) {
              ...
              a: do {
                switch (s[r >> 1] | 0) {
                  ...
                  case 101: {
                    if (
                      (((s[396] | 0) == 0 ? H(r) | 0 : 0) ? (m((e + 4) | 0, 16, 10) | 0) == 0 : 0)
                        ? (l(), (i[795] | 0) == 0)
                        : 0
                    ) {
                      b = 9
                ...
                e: while (1) {
                  ...
                  a: do {
                    switch (s[a >> 1] | 0) {
                      ...
                      case 101: {
                        if (
                          ((s[396] | 0) == 0 ? H(a) | 0 : 0) ? (m((e + 4) | 0, 16, 10) | 0) == 0 : 0
                        ) {
                          l()
                          b = 81
                        } else b = 81
                      ...
                      case 41: {
                        ...
                        if (
                          (r << 16) >> 16 != 0
                            ? ((u = t[((t[69] | 0) + (((r & 65535) + -1) << 2)) >> 2] | 0),
                              (t[(u + 20) >> 2] | 0) ==
                                (t[((t[68] | 0) + ((a & 65535) << 3) + 4) >> 2] | 0))
                            : 0
                        ) {
                          a = (u + 4) | 0
                          if (!(t[a >> 2] | 0)) t[a >> 2] = c
                    ...
                    default: {
                      ...
                      switch ((r << 16) >> 16) {
                        case 100: {
                          ...
                          if (
                            (C | 0) == 31
                              ? ((o = t[70] | 0), q(A) | 0, (h = t[70] | 0), h >>> 0 > o >>> 0)
                              : 0
                          ) {
                            $(e, l, o, h)
                            t[70] = (t[70] | 0) + -2
    ...
    for (; e.ri(); ) {
      const a = e.is(),
        ...
        f = e.se()
      let n
      e.ip() && (n = b(-1 === s ? a : a + 1, c$1.charCodeAt(-1 === s ? a - 1 : a))),
        w.push({ n: n, s: a, e: r, ss: t, se: f, d: s, a: i })
    }
    for (; e.re(); ) {
      const a = e.es(),
        r = e.ee(),
  ...
  function resolveDeps(load, seen) {
    ...
    function pushSourceURL(commentPrefix, commentStart) {
      ...
      resolvedSource += source.slice(urlStart, urlEnd)
      lastIndex = urlEnd
    }
